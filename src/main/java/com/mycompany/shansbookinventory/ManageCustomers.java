...
public class ManageCustomers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Manage Customers", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if (txtName.getText().isBlank() || txtMobile.getText().isBlank() || txtAddress.getText().isBlank())
            ...
            try {
                pst = con.prepareStatement("Insert into customers (Name,Phone,Address) values(?,?,?)");
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        try {
            ...
            pst = con.prepareStatement("Update customers set Name=?,Phone=?,Address=? where CustomerID =?");
            pst.setString(1, name);
            pst.setString(2, mobile);
            pst.setString(3, address);
            pst.setInt(4, id);
        ...
        if (dialogResult == JOptionPane.YES_OPTION) {
            try {
                ...
                if (ex instanceof java.sql.SQLIntegrityConstraintViolationException) {
                    JOptionPane.showMessageDialog(null, "Unable to to Delete\n" + "This customer's details are used somewhere in this program");
                } 
                else {
